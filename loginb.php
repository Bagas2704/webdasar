...
if (isset($_POST['username']) && isset($_POST['password'])) {
    ...
    if ($username == "usm" && $password == "123") {
        ...
        header("Location: dashboardboots.php");
        exit;
    } else {
...
<body class="d-flex align-items-center py-4 bg-body-tertiary"> <svg xmlns="http://www.w3.org/2000/svg" class="d-none">
    ...
    <main class="form-signin w-100 m-auto">
        <form method="POST" action="">
            ...
            <div class="text-center"><img class="mb-4"
                    src="https://usm.ac.id/wp-content/uploads/2022/09/Logo-USM-Color.png" alt="" height="120"></div>
